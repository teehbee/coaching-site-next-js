        ...
        <div className="container">
          <div className="row">
            <div className="col-10 offset-1 col-lg-7 offset-lg-5 dark-bg-color p-30 p-lg-45 mt--75 mt-lg-0 border-radius-5">
              <h2 className="mb-15 pos-relative custom-border-bottom custom-border-bottom-25-percent-ts">Overskrift her</h2>
              <div className="pb-15">Drivkraften är tydlig –att hjälpa människor att växa, hitta riktning och våga ta steg i både yrkesliv och privatliv.</div>
              <div>Drivkraften är tydlig –att hjälpa människor att växa, hitta riktning och våga ta steg i både yrkesliv och privatliv.</div>
            </div>
          </div>
        </div>
      </div>
