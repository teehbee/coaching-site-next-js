  ...
  return (
    <section className="p-0">
      <div className="container-fluid pos-relative p-0">
        <Image priority width={1920} height={650} className="img-cover h-60-md-80vh" src="/assets/img/placeholder/kenny-eliason-1-aA2Fadydc-unsplash.jpg" alt="placeholderbilde" />
