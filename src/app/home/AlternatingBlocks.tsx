          ...
          return (
            <div key={i} className="row pos-relative pb-60 align-items-center">
              <div className={`col-12 col-lg-5 ${!isEven ? "offset-lg-6" : "offset-lg-2"}`}>
                <Image width={636} height={477} className="img-cover border-radius-5 ar-3-2" src={block.frontpageAlternatingTilesImage.asset.url} alt={block.frontpageAlternatingTilesImage.alt || "Bildebeskrivelse mangler"} />
              </div>
