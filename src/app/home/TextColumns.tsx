  ...
  return (
    <section className="pb-45 pb-lg-90">
      <div className="container">
        <div className="row">
          <div className="col-12 col-lg-4 pr-lg-60 pb-30 d-flex flex-column">
            <div className="pb-15">
              <h3 className="pos-relative custom-border-bottom custom-border-bottom-25-percent-ts">Bengt Johansson</h3>
            </div>
